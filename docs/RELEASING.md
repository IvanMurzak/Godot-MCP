...
| --- | --- | --- |
| `com.IvanMurzak.ReflectorNet` | `5.4.1` | reflection / serialization core |
| `com.IvanMurzak.McpPlugin` | `8.4.0` | MCP plugin client (transitively pulls `McpPlugin.Common` + `ReflectorNet`) |

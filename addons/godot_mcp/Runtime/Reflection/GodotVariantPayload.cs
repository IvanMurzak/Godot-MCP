...
namespace com.IvanMurzak.Godot.MCP.Reflection
{
    ...
    public sealed class GodotVariantPayload
    {
        ...
        public const string WireFormatHelp =
            ...
            "Quaternion [x,y,z,w]; Color [r,g,b(,a)]; Plane [a,b,c,d]; Rect2/Rect2I [x,y,width,height]; " +
        ...
        public IReadOnlyList<double> Components { get; private set; }
        ...
        public static IEnumerable<VariantType> SupportedTypes =>
            new[]
            {
        ...
        static GodotVariantPayload ParseBareNumber(JsonElement json)
        {
            ...
            if (raw.IndexOf('.') < 0 && raw.IndexOf('e') < 0 && raw.IndexOf('E') < 0 && json.TryGetInt64(out var i))
                return FromInt(i);
            return FromFloat(json.GetDouble());
        }
        ...
        static VariantType ParseVariantType(string typeName)
        {
            ...
            if (!Enum.TryParse<VariantType>(trimmed, ignoreCase: true, out var kind) || !Enum.IsDefined(typeof(VariantType), kind))
        ...
        static double[] ReadComponents(VariantType kind, JsonElement value)
        {
            ...
            if (value.ValueKind == JsonValueKind.Object)
            {
                ...
                {
                    if (!TryFindProperty(value, new[] { name }, out var component, out _))
                        break;
        ...
        /// <summary>Case-insensitive property lookup so 'VariantType'/'variantType' and 'Obj'/'obj' both land.</summary>
        ...
        static string DescribeSupported()
            => string.Join(", ", SupportedTypes.Select(t => t.ToString()));

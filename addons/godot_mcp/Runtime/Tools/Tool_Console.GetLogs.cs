...
namespace com.IvanMurzak.Godot.MCP.Tools
{
    public partial class Tool_Console
    {
        ...
        [Description("Retrieve captured Godot-MCP editor log lines, newest-first. The Godot analog of " +
            ...
            "will NEVER appear here, and an empty result is NOT evidence that the game printed nothing. To " +
            "observe a running game, initialize the in-game runtime (GodotMcpRuntime.Initialize(b => " +
            "b.WithRuntimeErrorCapture()).Build() + Connect()) and read 'runtime-errors-get'.\n" +
            "Inputs:\n" +
